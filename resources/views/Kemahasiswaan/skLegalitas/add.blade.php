    ...
    <form action="{{ route('editSKlegalitas.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="flex flex-col items-center justify-center ml-4 md:ml-16 lg:ml-36 mt-4 md:mt-16 lg:mt-8 mr-10">
            <div class="items-center justify-center w-3/4 max-w-screen-lg mx-auto">
                <div id="id_ormawa" class="w-2/3 h-28 border border-customBlue p-4 rounded-lg mx-auto">
                    <label class="mb-2 font-semibold">Nama Ormawa</label>
                    <select id="id_ormawa" name="id_ormawa" class="w-full h-12 rounded-lg border border-customBlue mt-2">
                        <option value="">Silahkan Pilih Ormawa</option>
        ...
        <div class="flex flex-col items-center justify-center ml-4 md:ml-16 lg:ml-36 mt-4 md:mt-16 lg:mt-8 mr-10">
            <div class="items-center justify-center w-3/4 max-w-screen-lg mx-auto">
                <div id="nomor_SK" class="w-2/3 h-28 border border-customBlue p-4 rounded-lg mx-auto">
                    ...
                    <textarea id="nomor_SK" name="nomor_SK" class="w-full h-12 ps-2 pt-2 resize-none rounded-lg border border-customBlue"></textarea>
                </div>
            </div>
        </div>
        <div class="flex flex-col items-center justify-center ml-4 md:ml-16 lg:ml-36 mt-4 md:mt-16 lg:mt-8 mr-10">
            <div class="items-center justify-center w-3/4 max-w-screen-lg mx-auto">
                <div id="tanggal_terbit" class="w-2/3 h-28 border border-customBlue p-4 rounded-lg mx-auto">
                    ...
                    <input type="date" id="tanggal_terbit" name="tanggal_terbit"
                        class="w-full h-12 rounded-lg border border-customBlue">
                </div>
            </div>
        </div>
        <div class="flex flex-col items-center justify-center ml-4 md:ml-16 lg:ml-36 mt-4 md:mt-16 lg:mt-8 mr-10">
            <div class="items-center justify-center w-3/4 max-w-screen-lg mx-auto">
                <div id="tanggal_berlaku_mulai" class="w-2/3 h-28 border border-customBlue p-4 rounded-lg mx-auto">
                    ...
                    <input type="date" id="tanggal_berlaku_mulai" name="tanggal_berlaku_mulai"
                        class="w-full h-12 rounded-lg border border-customBlue">
                </div>
            </div>
        </div>
        <div class="flex flex-col items-center justify-center ml-4 md:ml-16 lg:ml-36 mt-4 md:mt-16 lg:mt-8 mr-10">
            <div class="items-center justify-center w-3/4 max-w-screen-lg mx-auto">
                <div id="tanggal_berlaku_selesai" class="w-2/3 h-28 border border-customBlue p-4 rounded-lg mx-auto">
                    ...
                    <input type="date" id="tanggal_berlaku_selesai" name="tanggal_berlaku_selesai"
                        class="w-full h-12 rounded-lg border border-customBlue">
                </div>
            </div>
        </div>
        <div class="flex flex-col items-center justify-center ml-4 md:ml-16 lg:ml-36 mt-4 md:mt-16 lg:mt-8 mr-10">
            <div class="items-center justify-center w-3/4 max-w-screen-lg mx-auto">
                <div
                    class="w-3/4 md:w-3/4 lg:w-2/3 h-auto bg-customWhite border border-customBlue rounded-md mx-auto shadow-xl">
                    ...
                    <div
                        ...
                        <label for="file_SK" class="cursor-pointer flex flex-col items-center">
                            ...
                            <p class="text-xs md:text-sm lg:text-base text-customBlack">Klik untuk Unggah atau seret dan
                                lepas</p>
                    ...
                    <div id="loading"
                        ...
                        <div class="flex flex-col items-start justify-center ml-2 md:ml-4 w-3/4">
                            ...
                            <progress id="file-progress" value="0" max="100"
